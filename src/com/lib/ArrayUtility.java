...
public final class ArrayUtility {
	...
	/**
	 * Predicates the specified {@code a} using the specified {@code predicate}
	 * for filtering.
	 * 
	 * @param a
	 *            the array to filter
	...
	/**
	 * Concatenates the specified array, {@code a} with the specified array
	 * {@code b}.
	 * 
	 * @param a
	 *            the array to join with array b
	 * @param b
	 *            the array to append to the end of array a
	 * @return an array with the two specified arrays concatenated
	 */
	public static <T> T[] concat(T[] a, T[] b) {
		T[] arr = (T[]) Array.newInstance(a.getClass(), a.length + b.length);
	...
	public static int[] concat(int[] a, int[] b) {
		int[] arr = (int[]) Array.newInstance(int[].class, a.length + b.length);
		System.arraycopy(a, 0, arr, 0, a.length);
		System.arraycopy(b, 0, arr, a.length, b.length);
		return arr;
	}
	...
	public static float[] concat(float[] a, float[] b) {
		float[] arr = (float[]) Array.newInstance(float[].class, a.length + b.length);
		System.arraycopy(a, 0, arr, 0, a.length);
		System.arraycopy(b, 0, arr, a.length, b.length);
		return arr;
	}
	...
	public static long[] concat(long[] a, long[] b) {
		long[] arr = (long[]) Array.newInstance(long[].class, a.length + b.length);
		System.arraycopy(a, 0, arr, 0, a.length);
		System.arraycopy(b, 0, arr, a.length, b.length);
		return arr;
	}
	...
	public static byte[] concat(byte[] a, byte[] b) {
		byte[] arr = (byte[]) Array.newInstance(byte[].class, a.length + b.length);
		System.arraycopy(a, 0, arr, 0, a.length);
		System.arraycopy(b, 0, arr, a.length, b.length);
		return arr;
	}
	...
	public static short[] concat(short[] a, short[] b) {
		short[] arr = (short[]) Array.newInstance(short[].class, a.length + b.length);
		System.arraycopy(a, 0, arr, 0, a.length);
		System.arraycopy(b, 0, arr, a.length, b.length);
		return arr;
	}
	...
	public static boolean[] concat(boolean[] a, boolean[] b) {
		boolean[] arr = (boolean[]) Array.newInstance(boolean[].class, a.length + b.length);
		System.arraycopy(a, 0, arr, 0, a.length);
		System.arraycopy(b, 0, arr, a.length, b.length);
		return arr;
	}
	...
	public static double[] concat(double[] a, double[] b) {
		double[] arr = (double[]) Array.newInstance(double[].class, a.length + b.length);
		System.arraycopy(a, 0, arr, 0, a.length);
		System.arraycopy(b, 0, arr, a.length, b.length);
		return arr;
	}
	...
	public static char[] concat(char[] a, char[] b) {
		char[] arr = (char[]) Array.newInstance(char[].class, a.length + b.length);
		System.arraycopy(a, 0, arr, 0, a.length);
		System.arraycopy(b, 0, arr, a.length, b.length);
		return arr;
	}
